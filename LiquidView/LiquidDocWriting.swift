...
nonisolated enum ACMLaTeX {
    ...
    static func latex(for doc: LiquidDoc, style: Style = .sigconf,
                      rights: Rights = .ccBy) -> String {
        var out: [String] = [
        ...
        out.append(contentsOf: preamble(for: doc, rights: rights))
    ...
    private static func preamble(for doc: LiquidDoc, rights: Rights) -> [String] {
        var out: [String] = []
